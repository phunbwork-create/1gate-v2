-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'DIRECTOR', 'ACCOUNTANT', 'DEPT_HEAD', 'PURCHASER', 'WAREHOUSE', 'EMPLOYEE');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('SUBMISSION', 'APPROVAL', 'REJECTION', 'REMINDER', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "notification_channels_userId_key" ON "notification_channels"("userId");
